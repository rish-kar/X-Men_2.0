...
- **🪝 Depends on:** ANTLR-generated lexer in `src/main/java/com/sermas/x/men/model`.
...
| --- | --- |
| ANTLR parser classes under `src/main/java/com/sermas/x/men/model`; parsing helpers in `src/main/java/com/sermas/x/men/utilities`. | Surefire / CI runs. |
