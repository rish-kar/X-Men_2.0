...
class ApplicationTests {
  ...
  void main_delegatesToSpring() {
    try (MockedStatic<SpringApplication> spring = Mockito.mockStatic(SpringApplication.class)) {
          ...
          .when(
              () ->
                  SpringApplication.run(
                      Mockito.eq(com.sermas.x.men.Application.class), Mockito.any()))
          .thenReturn(fakeCtx);
      ...
      com.sermas.x.men.Application.main(new String[] {"arg"});
  ...
  void run_headlessBranch() {
    try (MockedStatic<GraphicsEnvironment> ge = Mockito.mockStatic(GraphicsEnvironment.class);
      ...
      new com.sermas.x.men.Application().run(); // invoke CommandLineRunner
  ...
  void run_guiBranch() {
    try (MockedStatic<GraphicsEnvironment> ge = Mockito.mockStatic(GraphicsEnvironment.class);
      ...
      new com.sermas.x.men.Application().run();
