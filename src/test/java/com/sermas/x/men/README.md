...
```text
src/test/java/com/sermas/x/men    ←  you are here
...
| --- | --- |
| Production code under `src/main/java/com/sermas/x/men`. | Maven Surefire and IDE test runners. |
