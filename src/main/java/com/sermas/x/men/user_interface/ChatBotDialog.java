...
import com.sermas.x.men.service.chatbot.ChatBotService;
import com.sermas.x.men.service.chatbot.ChatBotService.Reply;
 ...
 * has been removed because it confused users — the assistant is always local.
 */
@Slf4j
public final class ChatBotDialog {
  ...
  private static void addBubble(VBox column, String text, boolean fromUser) {
    ...
    if (fromUser) {
      ...
      col.setMaxWidth(440);
      col.setPadding(new Insets(10, 14, 10, 14));
