        ...
        try {
            ...
            if (originalRule.getPreconditionFactByMatchingName("Rcv") != null &&
                ...
                for (Fact f : mutatedRule.getActions()) {
                    if (f.getF_name().equals("Snd") || f.getF_name().equals("To") || f.getF_name().equals("Rcv") || f.getF_name().equals("From")) {
                        f.setRemoved(true);
                    }
                }
                ...
                if (mutatedRule.getPostconditionFactByMatchingName("State") != null) {
                    mutatedRule.getPostconditions().set(0,  utilityFunctions.buildNewState(mutatedRule.getPreconditions(), preconditionState));
                }
                ...
                log.warn("The rule does not contain the required precondition 'Rcv' or postcondition 'Snd'.");
            }
        } catch (Exception e) {
