...
- **🪝 Depends on:** `com.sermas.x.men.user_interface.XMenInterface`.
- **⚠️ Heads-up:** Changing startup affects both API and UI modes. Keep the `@SpringBootApplication` package scan aligned with `com.sermas.x.men`.
