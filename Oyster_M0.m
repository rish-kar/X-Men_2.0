...
rule H_2:
[ State($Human,'2',<$oyster,$ccard,bal($ccard)>)
...
[ State($Human,'3',<$oyster,$ccard,bal($ccard),~gid>)
...
[ State($Human,'4',<$oyster,$ccard,bal($oyster),bal($ccard),~gid,'finish'>)
]
